...
//   bool _hasMembership = false; // Track membership status
...
//         // Ensure the snapshot contains data and cast it to Map<String, dynamic>
//         if (snapshot.snapshot.exists && snapshot.snapshot.value != null) {
//           var userData =
//               Map<String, dynamic>.from(snapshot.snapshot.value as Map);

//           // Convert 'membershipPlan' from string to boolean
//           setState(() {
//             _hasMembership = userData['membershipPlan'] == 'true';
//           });
//         }
//       });
//     }
...
//               if (_hasMembership)
//                 const Text(
//                   'You already have a premium membership! Enjoy your courses.',
//                   textAlign: TextAlign.center,
...
//     // Update user's membership plan in Firebase
//     if (_user != null) {
//       _userRef = FirebaseDatabase.instance.ref("users/${_user.uid}");
...
//     var options = {
//       'key': 'rzp_live_C4QRSwJt17HkUA', // Replace with your Razorpay API key
//       'amount': amount * 100, // Convert price to paise
//       'name': "Skill UP Premium",
//       'description': 'Premium Subscription',
//       'prefill': {
//         'contact': _user.phoneNumber ?? '', // Optional: prefill user contact
...
//           'paytm',
//           'phonepe',
//         ] // Optional: enable specific wallets
//       }
//     };
...
//   // Rest of the payment handling methods remain the same...
// }
import 'package:flutter/material.dart';
import 'package:razorpay_flutter/razorpay_flutter.dart';
import 'package:firebase_auth/firebase_auth.dart';
...
class _MembershipPageState extends State<MembershipPage> {
      ...
      _userRef.once().then((snapshot) {
        if (snapshot.snapshot.exists && snapshot.snapshot.value != null) {
          ...
          setState(() {
            ...
            // _selectedDuration = userData['membershipDuration'] ?? '';
          });
        }
      });
    }
  ...
  void _openCheckout(int amount, String duration) async {
    ...
    var options = {
      'key': 'rzp_live_C4QRSwJt17HkUA', // Replace with your key
      'amount': amount * 100,
      'name': "Skill UP Premium",
      'description': 'Premium Subscription',
      'prefill': {
